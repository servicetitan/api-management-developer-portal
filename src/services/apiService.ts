...
export class ApiService {
    private readonly customDescriptions: Record<string, string> = {
        ...
        "tenant-marketing-ads-v2": "External Call Attributions, Web Booking Attributions endpoints.",
        ...
        "tenant-payroll-v2": "Activity Codes, Employee Payrolls, Gross Pay Items, Job Splits, Payroll Adjustments, Payroll Locations, Payrolls, Technician Payrolls, Timesheet Codes endpoints.",
